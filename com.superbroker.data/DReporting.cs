...
namespace com.superbroker.data
{
    public class DReporting  : DbCenter, IDB<Reporting>
    {
        ...
        public List<Reporting> Get(string CustomName, string CustomMobile, string BuilderName, string BrokerNo, string ReportNo, DateTime begin, DateTime end, int state, int pageno, out int pageCount)
        {
